...
| 황남주   | UX/UI 디자인, 모바일 개발                                | namuju_hi@naver.com   |
...
> 강아지 비문 인식 데이터 
 ...
 학습데이터는 **CVPR2022 Biometrics Workshop Pet Biometric Challenge**에 첨부된 데어테 셋 중에 강아지 비문이 보이는 사진들로 선별하고, 구글폼을 통해 팀원들의 인스타그램에 올려 반려견이 있는 지인들에게 얻은 데이터를 이미지 증강을 이용해 학습데이터를 만들었다. 
...
| ------ | --------------- | --------------- | -------------------- |
| 정확도 | mAP50-95: 0.952 | mAP50-95: 0.952 | mAP50-95: 0.952      |
